...
function SignupContent() {
  ...
  return (
    <div className="min-h-screen min-h-dvh overflow-y-auto md:overflow-hidden md:h-screen w-full bg-[#FFF8F0] dark:bg-[#121212] text-[#222222] dark:text-[#FFF8F0] flex flex-col md:flex-row relative select-none">
      ...
      <BrandSidePanel
        actions={navActions}
        subtitle="Join progressive educational institutions and proactive families supporting adolescent mental wellness."
      />

      {/* ── RIGHT SIDE: Compact Signup Workspace ─────── */}
      <div className="w-full md:w-7/12 lg:w-[54%] min-h-full h-auto md:h-full flex flex-col justify-center px-4 sm:px-8 lg:px-12 py-6 pb-14 md:py-3 overflow-y-auto relative">
      ...
      <div className="hidden md:block absolute bottom-4 right-5 z-20 text-[10px] font-mono tracking-wider text-[#222222]/40 dark:text-[#FFF8F0]/40 pointer-events-none">
        JaagrMind © 2026
      </div>
    </div>
  );
