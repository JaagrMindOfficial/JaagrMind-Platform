...
export function BrandSidePanel({ subtitle, actions }: BrandSidePanelProps) {
  return (
    <div className="w-full md:w-5/12 lg:w-[46%] h-auto md:h-full flex flex-col justify-between p-5 sm:p-10 lg:p-14 border-b md:border-b-0 md:border-r border-[#222222]/10 dark:border-white/10 relative overflow-hidden bg-[#FFF5EA]/70 dark:bg-[#151515] shrink-0 select-none">
      ...
      {/* ── Top: Logo & Mobile Actions (perfectly aligned on the same row) ── */}
      <div className="relative z-10 flex items-center justify-between w-full">
        <Link href="/" className="inline-flex items-center transition-opacity hover:opacity-90 shrink-0">
          <img
            src="/DarkColorLogo.svg"
            alt="JaagrMind Logo"
            className="h-7 sm:h-8 md:h-9 w-auto dark:hidden object-contain"
          />
          <img
            src="/LightColorLogo.svg"
            alt="JaagrMind Logo"
            className="h-7 sm:h-8 md:h-9 w-auto hidden dark:block object-contain"
          />
        </Link>
      ...
      <div className="relative z-10 space-y-3 sm:space-y-4 my-auto py-4 md:py-6">
        ...
        <h1 className="text-3xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-[#222222] dark:text-[#FFF8F0] leading-[1.08]">
          Making <br />
          Young Minds <br />
          <span className="font-highlight font-bold text-[#42B677] text-4xl sm:text-6xl lg:text-7xl italic inline-block underline decoration-[#91D17C]/60 decoration-wavy decoration-2 underline-offset-8">
            aware
          </span>
        </h1>
