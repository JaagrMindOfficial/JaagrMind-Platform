...
export function ParentHeader({
  ...
  return (
    <header className="sticky top-0 z-40 w-full liquid-glass border-b border-border/50 transition-all">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3 sm:gap-5">
          ...
          <div className="flex items-center gap-2">
            <DropdownMenu>
              ...
              <DropdownMenuContent align="start" className="w-64 clay-card p-1.5 border-border">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <Button
            ...
            className="hidden sm:flex text-xs h-8 gap-1.5 neo-well hover:bg-muted/40 font-medium"
          >
          ...
          {/* User Profile / Logout */}
          <DropdownMenu>
            <DropdownMenuTrigger className="h-8 w-8 rounded-full bg-foreground/10 text-foreground flex items-center justify-center text-xs font-bold border border-border/80 hover:bg-foreground/15 transition-colors">
              {parentName ? parentName.charAt(0).toUpperCase() : "P"}
            </DropdownMenuTrigger>
            <DropdownMenuContent align="end" className="w-52 clay-card p-1.5 border-border">
